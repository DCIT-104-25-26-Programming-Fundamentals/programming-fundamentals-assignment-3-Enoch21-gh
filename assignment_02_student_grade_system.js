...
/**
 * Determines the letter grade based on a given numerical score.
 *
 * @param {number} score - The student's numerical score.
 * @returns {string|null} The corresponding grade string or null if the score is invalid.
 */
function getGrade(score) {
  ...
  // Determine grade based on range
  if (score >= 80) {
    return 'A';
  } else if (score >= 70) {
    return 'B';
